...
const FALLBACK_SEEDS: Record<string, Omit<LiveTickerData, 'lastUpdated' | 'isLive'>> = {
  'BTC/USDT': { symbol: 'BTC/USDT', price: 60000,  change24h: 0, high24h: 61000,  low24h: 59000,  volume24hUsd: 25000000000, bid: 59999, ask: 60001 },
  'ETH/USDT': { symbol: 'ETH/USDT', price: 3200,   change24h: 0, high24h: 3250,   low24h: 3150,   volume24hUsd: 12000000000, bid: 3199,  ask: 3201  },
  'SOL/USDT': { symbol: 'SOL/USDT', price: 140,    change24h: 0, high24h: 145,    low24h: 135,    volume24hUsd: 4000000000,  bid: 139.9, ask: 140.1 },
  'NVDA':     { symbol: 'NVDA',     price: 115,    change24h: 0, high24h: 118,    low24h: 112,    volume24hUsd: 30000000000, bid: 114.9, ask: 115.1 },
  'SPY':      { symbol: 'SPY',      price: 540,    change24h: 0, high24h: 542,    low24h: 538,    volume24hUsd: 50000000000, bid: 539.9, ask: 540.1 },
  'QQQ':      { symbol: 'QQQ',      price: 460,    change24h: 0, high24h: 462,    low24h: 458,    volume24hUsd: 25000000000, bid: 459.9, ask: 460.1 },
  'TSLA':     { symbol: 'TSLA',     price: 230,    change24h: 0, high24h: 235,    low24h: 225,    volume24hUsd: 15000000000, bid: 229.9, ask: 230.1 },
  'AAPL':     { symbol: 'AAPL',     price: 215,    change24h: 0, high24h: 218,    low24h: 212,    volume24hUsd: 18000000000, bid: 214.9, ask: 215.1 },
  'MSFT':     { symbol: 'MSFT',     price: 420,    change24h: 0, high24h: 424,    low24h: 416,    volume24hUsd: 22000000000, bid: 419.9, ask: 420.1 },
  'AMZN':     { symbol: 'AMZN',     price: 190,    change24h: 0, high24h: 193,    low24h: 187,    volume24hUsd: 12000000000, bid: 189.9, ask: 190.1 },
}
...
class RealTimeMarketDataService {
  ...
  /** Returns all live ticker data (fetches if stale) */
  async fetchAllPrices(): Promise<Map<string, LiveTickerData>> {
    if (this.fetchInFlight) return this.cache
    if (Date.now() - this.lastFetchAttempt < CACHE_TTL_MS) return this.cache
